...
if __name__=='__main__':
    ...
    create_model_command = ["./GloVe/build/glove -input-file data/all_dicts_syns_cooccurrences.bin -vocab-file data/all_dicts_syns_vocab.txt -vector-size 300 -iter 100 -eta .01 -save-file data/embeddings_word/embeddings_all_dicts_syns-300-100"]
