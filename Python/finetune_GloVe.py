...
if __name__=='__main__':
    ...
    create_model_command = ["./GloVe/build/glove -input-file data/all_dicts_syns_cooccurrences.bin -vocab-file data/all_dicts_syns_vocab.txt -vector-size 300 -save-file data/embeddings_all_dicts_syns.txt"]
