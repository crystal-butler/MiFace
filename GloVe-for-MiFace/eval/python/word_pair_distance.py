...
parser.add_argument('--source_dir', help="a directory containing lists of word pairs; requires output_dir to work",
                    default=None, type=str)
parser.add_argument('--output_dir', help="a directory to write similarity values to", default=None, type=str)
...
def generate():
    ...
    print("vocab_size is %d and vector_dim is %d" % (vocab_size, vector_dim))
...
def distance(W, vocab, ivocab, input_term1, input_term2):
    ...
    # Set the first word's distance to itself to one, for a perfect match.
    dist[index1] = 1
    return dist[index2]
        ...
        while True:
            ...
            if input_term2 == 'EXIT':
                ...
                if similarity == -1:
                    ...
                    print("From 0 to 1, the simlarity of %s and %s is %f." % (input_term1, input_term2, similarity))
